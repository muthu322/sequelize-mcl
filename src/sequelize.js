...
import migrate_one from './commands/migrate_one';
...
yargs
  .help()
  .version()
  .command('db:migrate', 'Run all pending migrations', migrate)
  .command('db:migrate:one', 'Run only one pending migrations', migrate_one) //run only one migration
  .command(
